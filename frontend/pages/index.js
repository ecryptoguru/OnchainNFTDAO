...
import {
  AnkitPunksDAOABI,
  AnkitPunksDAOAddress,
  AnkitPunksNFTABI,
  AnkitPunksNFTAddress,
...
export default function Home() {
  ...
  const daoOwner = useContractRead({
    abi: AnkitPunksDAOABI,
    address: AnkitPunksDAOAddress,
    functionName: "owner",
  });
  ...
  // Fetch the AnkitPunks NFT balance of the user
  const nftBalanceOfUser = useContractRead({
    abi: AnkitPunksNFTABI,
    address: AnkitPunksNFTAddress,
  ...
  function renderCreateProposalTab() {
    if (loading) {
      ...
      return (
        <div className={styles.description}>
          You do not own any AnkitPunks NFTs. <br />
  ...
  return (
    <div className={inter.className}>
      <Head>
        <title>AnkitPunks DAO</title>
        <meta name="description" content="AnkitPunks DAO" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Ankit Punks!</h1>
          <div className={styles.description}>Welcome to the DAO!</div>
          <div className={styles.description}>
            Your AnkitPunks NFT Balance: {nftBalanceOfUser.data.toString()}
            <br />
            {daoBalance.data && (
              <>
                Treasury Balance:{" "}
        ...
        <div>
          <img className={styles.image} src="https://i.imgur.com/TkUKxEj.png" />
        </div>
      </div>
    </div>
  );
